...
const AIHelper = () => {
  const [messages, setMessages] = useState([
    { role: 'ai', text: "Hello! I'm Opportunity Intelligence. I'm here to simplify your access to government schemes and support services. What can I help you find today?" }
  ]);
    ...
    <div className="flex h-[calc(100vh-88px)] bg-[#f8fafc] font-sans text-slate-800 overflow-hidden relative">
      ...
      <aside className="hidden md:flex flex-col w-[320px] bg-white border-r border-slate-200/60 h-full z-20 shadow-[4px_0_24px_rgba(0,0,0,0.02)]">
        <div className="p-6 border-b border-slate-100 flex items-center justify-between">
            <button className="w-full flex items-center justify-center gap-2 bg-slate-900 hover:bg-blue-600 text-white py-3.5 rounded-xl font-bold transition-all shadow-lg shadow-slate-900/10 uppercase tracking-wider text-sm">
        ...
        <div className="p-6 border-t border-slate-100 bg-slate-50 mt-auto">
            <div className="flex items-center gap-4">
                <div className="w-12 h-12 rounded-2xl bg-gradient-to-br from-emerald-400 to-emerald-600 flex items-center justify-center text-white shadow-xl shadow-emerald-500/20">
                    <svg width="22" height="22" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2.5" strokeLinecap="round" strokeLinejoin="round"><path d="M12 2a10 10 0 1 0 0 20 10 10 0 1 0 0-20z"/><path d="M12 8v4l3 3"/></svg>
                </div>
                <div>
                    <div className="text-sm font-black text-slate-800 tracking-tight">Intelligence API</div>
                    <div className="text-[0.65rem] text-emerald-600 font-bold tracking-[0.2em] mt-1 flex items-center gap-1.5">
      ...
      <main className="flex-1 flex flex-col h-full relative bg-[#f8fafc]">
        ...
        <div className="md:hidden p-4 border-b border-slate-200/60 bg-white/80 backdrop-blur-md flex items-center justify-between shadow-sm z-20">
            <div className="flex items-center gap-3">
                ...
                <div className="text-sm font-black text-slate-800">Opportunity AI</div>
            </div>
            <button className="text-xs font-bold bg-slate-900 text-white px-4 py-2 rounded-lg">New Chat</button>
        </div>

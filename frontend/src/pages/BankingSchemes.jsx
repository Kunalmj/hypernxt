...
const BENEFICIARY_TYPES = ["All Beneficiaries", "BPL Family", "General Public", "Street Vendors", "Small Business", "Women"];
      ...
      <div className="max-w-6xl mx-auto px-4 md:px-6 py-8 flex gap-6 items-start">
        ...
        {showFilters && (
          <aside className="w-64 flex-shrink-0 bg-white rounded-2xl p-5 sticky top-[96px]"
            ...
            <button
              onClick={() => setFilters({ state: "All States", beneficiaryType: "All Beneficiaries", gender: "All Genders", sponsor: "All Sponsors" })}

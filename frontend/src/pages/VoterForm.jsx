  ...
  return (
    <div className="h-screen bg-slate-50 flex items-center justify-center p-0 md:p-10 font-sans overflow-hidden">
      <div className="w-full max-w-6xl h-full md:h-[90vh] bg-white rounded-none md:rounded-[1rem] shadow-2xl flex flex-col md:flex-row overflow-hidden">
        ...
        <aside className="no-scrollbar w-full md:w-80 bg-blue-100 backdrop-blur-xl p-4 md:p-10 flex flex-col border-b md:border-b-0 md:border-r border-emerald-100 h-auto md:h-full sticky top-0 z-30">
          <div className="mb-2 md:mb-10">
            <h2 className="text-lg md:text-xl font-bold text-slate-800 mt-1 md:mt-2">Voter Service Portal</h2>
          </div>
        ...
        >
          <form className="space-y-12" onSubmit={(e) => { e.preventDefault() }}>
            ...
            <div data-step-id="3" className="pt-12 space-y-8">
              <div className="space-y-1">
                <p className="text-[10px] font-black text-blue-600 uppercase tracking-[0.2em]">Request Classification</p>
                <h3 className="text-2xl font-black text-blue-800 tracking-tight">Service Type</h3>
              </div>
              <select name="requestType" value={formData.requestType} onChange={handleInputChange} className="w-full px-0 py-3 border-b-2 border-slate-100 focus:border-emerald-500 outline-none transition-all text-lg font-bold text-slate-700 bg-transparent">
            ...
            <div data-step-id="4" className="pt-12 space-y-8">
              <div className="space-y-1">
                ...
                <h3 className="text-2xl font-black text-slate-800 tracking-tight">Identity Proof</h3>
              </div>
              <div className="space-y-6">
                <div className="space-y-4">
                  <label className="text-xs font-bold text-blue-400 uppercase tracking-wider ml-1">Select Document</label>
                  <select name="idProof" value={formData.idProof} onChange={handleInputChange} className="w-full px-0 py-3 border-b-2 border-slate-100 focus:border-emerald-500 outline-none transition-all font-bold text-slate-600 bg-transparent mb-4">
            ...
            <div data-step-id="5" className="pt-12 space-y-8 pb-10">
              <div className="space-y-1">
                ...
                <h3 className="text-2xl font-black text-slate-800 tracking-tight">Applicant Photo</h3>
              </div>
              <div className="flex flex-col md:flex-row gap-6">
                ...
                <div className="w-full md:w-32 h-32 rounded-none bg-slate-50 border border-slate-100 flex items-center justify-center text-[10px] font-bold text-slate-300 text-center p-2 uppercase">Preview</div>
              </div>
            </div>

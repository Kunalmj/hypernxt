        ...
        {!isExactMatch && query && (
           <div className="bg-blue-50 border-l-4 border-blue-500 p-4 rounded-r-lg mb-8 shadow-sm flex items-start gap-4">
              ...
              <div>
                ...
                <p className="text-blue-700 text-sm mt-1">We couldn't find grants matching all your criteria. Here are other opportunities you might consider.</p>
              </div>
           </div>
        )}
                ...
                <div className="w-full border-t border-slate-100 pt-6 mt-2 animate-fadeIn">
                  ...
                  <div className="grid grid-cols-2 md:grid-cols-4 gap-3 mb-6">
                    <div className="bg-blue-50 rounded-xl p-4 border border-blue-100">
                      ...
                      <p className="text-base font-bold text-blue-700">{grant.amount}</p>
                    </div>
                    <div className="bg-blue-50 rounded-xl p-4 border border-blue-100">
                      <p className="text-xs font-semibold text-blue-400 uppercase tracking-wider mb-1">Deadline</p>
                      <p className="text-base font-bold text-blue-600">{grant.deadline}</p>
                    </div>
                    <div className="bg-blue-50 rounded-xl p-4 border border-blue-100">
                    ...
                    <div className="bg-blue-50 rounded-xl p-4 border border-blue-100">
                      ...
                      <p className="text-sm font-bold text-blue-700">{grant.applicationMode || "Online"}</p>
                    </div>
                  </div>
                      ...
                      {grant.importantDates && (
                        <div className="grid grid-cols-2 gap-3 mb-4">
                          ...
                          <div>
                            ...
                            <p className="text-sm font-semibold text-blue-600">{grant.importantDates.applicationEnd}</p>
                          </div>
                          <div>
                          ...
                          <div>
                            ...
                            <p className="text-sm font-semibold text-blue-600">{grant.importantDates.disbursement}</p>
                          </div>
                        </div>
                      )}
                      {grant.contact && (
                  ...
                  <div className="mt-5 flex flex-col sm:flex-row items-center gap-3 justify-between bg-gradient-to-r from-blue-50 to-blue-50 rounded-xl p-4 border border-blue-100">
                    ...
                    >
                      ...
                      <span className="font-medium">{grant.website || "Official website"}</span>
                    </a>
                    <button
                      onClick={() => navigate("/startup-apply", { state: { grant: grant } })}

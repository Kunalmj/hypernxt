          ...
          <div className="grid grid-cols-1 lg:grid-cols-12 gap-12 lg:gap-8 items-center">
            ...
            <div className="lg:col-span-6 xl:col-span-5 text-center lg:text-left flex flex-col justify-center">
              ...
              <p className="text-[#475569] text-[1.05rem] md:text-[1.2rem] leading-relaxed max-w-xl mx-auto lg:mx-0 font-medium mb-8 animate-[fadeIn_1.4s_ease-out]">
                FormEase is your all-in-one platform to discover, understand, and apply for opportunities that matter — from government schemes to grants, programs, and more. We bring everything together in one simple, secure place so you can focus on what truly matters.              </p>

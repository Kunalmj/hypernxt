      ...
      <div className="container mx-auto px-6 py-24">
        <div className="grid grid-cols-1 lg:grid-cols-3 gap-16">
          <div className="lg:col-span-2 space-y-16">
            ...
            {/* What we track */}
            <section>
              <h2 className="text-3xl font-black text-slate-900 mb-8">What we track</h2>
              <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
                {[
                  { t: "Scholarship Status", d: "Live updates from NSP, state scholarship portals and university boards." },
                  { t: "Subsidy Claims", d: "DBT transfer status and payment disbursement tracking for all schemes." },

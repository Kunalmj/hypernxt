...
const StartupHelp = () => {
  ...
  return (
    <div className="min-h-screen bg-[#f8fbff] font-['Inter',_sans-serif]">
      {showModal && <RequestServiceModal service="Startup Grant Assistance" onClose={() => setShowModal(false)} />}
        ...
        <div className="grid grid-cols-1 lg:grid-cols-3 gap-16">
          <div className="lg:col-span-2 space-y-16">
            ...
            <section className="bg-blue-600 p-12 rounded-[3.5rem] text-white">
              <h3 className="text-2xl font-black mb-4">Ready to grow your startup?</h3>
              <p className="text-blue-100 font-medium mb-8">Join thousands of entrepreneurs who secured government funding through our platform.</p>
              <button
          ...
          <div className="space-y-8">
            <div className="bg-white p-8 rounded-[2.5rem] border border-slate-100 shadow-xl shadow-blue-500/5">
              ...
              <div className="space-y-6">
                <div>
                  <div className="text-3xl font-black text-slate-900 tracking-tighter">₹300Cr+</div>
                  <div className="text-[0.7rem] font-bold text-slate-400 uppercase tracking-widest">Grants Secured</div>
                </div>
                <div>
                  <div className="text-3xl font-black text-slate-900 tracking-tighter">18k+</div>
                  <div className="text-[0.7rem] font-bold text-slate-400 uppercase tracking-widest">Startups Assisted</div>
                </div>
              </div>
            </div>
          </div>

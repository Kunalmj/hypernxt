        ...
        {submitted ? (
          ...
          <form onSubmit={handleSubmit} className="px-6 py-5 space-y-4 bg-white">
            <div className="grid grid-cols-2 gap-3.5">
              <div>
                <label className="block text-[0.78rem] font-bold text-[#0f172a] mb-1.5">Full Name <span className="text-red-500">*</span></label>
              ...
              <div>
                <label className="block text-[0.78rem] font-bold text-[#0f172a] mb-1.5">Email Address <span className="text-red-500">*</span></label>
            ...
            <div className="grid grid-cols-2 gap-3.5">
              <div>
                <label className="block text-[0.78rem] font-bold text-[#0f172a] mb-1.5">Phone Number <span className="text-red-500">*</span></label>
            ...
            <div>
              <label className="block text-[0.78rem] font-bold text-[#0f172a] mb-1.5">Brief Description / Remarks <span className="text-red-500">*</span></label>
            ...
            <div>
              <label className="block text-[0.78rem] font-bold text-[#0f172a] mb-2.5">Preferred Contact Method <span className="text-red-500">*</span></label>
